...
with open('distilbert_results/train_results.json', 'w') as f:
    json.dump({'metrics': train_metrics, 'history': train_history}, f, indent=4)
print("Training results saved to distilbert_results/train_results.json")
...
with pd.ExcelWriter('distilbert_results/test_results.xlsx') as writer:
...
print("Test results saved to distilbert_results/test_results.xlsx")
...
plt.legend()
plt.savefig('distilbert_results/training_loss_curve.png')
plt.show()
...
plt.savefig('distilbert_results/confusion_matrix.png')
plt.show()
...
plt.title('Class Distribution in Training Set (DistilBERT)')
plt.savefig('distilbert_results/class_distribution.png')
plt.show()

print("Graphs saved as PNG files in distilbert_results folder.")